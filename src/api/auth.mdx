...
If your authentication token is 1a2b3 then the command should be:
```bash
curl -H 'Authorization: Bearer 1a2b3 https://sentry.io/api/0/projects/
```
...
<Alert level="warning" title="number0834855134">
